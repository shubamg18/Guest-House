...
<head>
    <title>GUEST HOUSE | Services </title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body class="home-page">
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item"><a href="WebForm1.aspx">Home Page</a></li>
                        <li class="nav-item"><a href="Services.aspx">Services</a></li>
                        <li class="nav-item"><a href="Gallery.aspx">Gallery</a></li>
                        <li class="active nav-item"><a href="Booking.aspx">Booking</a></li>
        ...
        <div class="container">
            <div class="col-md-12" style="background-color:#f5f5f5; padding:5px 5px 5px 5px;">
                    <h3>Reservation:</h3>
						<form action="" id="reservation-form">
					 		<fieldset>
								<div class="field"><label>Check In:</label><select class="select1"><option>30</option></select><select class="select2"><option>April 2009</option></select></div><br />
								<div class="field"><label>Check Out:</label><select class="select1"><option>01</option></select><select class="select2"><option>May 2009</option></select></div><br />
								<div class="field">Persons: &nbsp;<input type="text" value="1"/>&nbsp; &nbsp; &nbsp; &nbsp; Rooms:&nbsp; <input type="text" value="1"/></div><br />
								<button type="button"><a href="#" onclick="document.getElementById('reservation-form').submit()">Check Availability</a></button>
							</fieldset>
						</form>
                </div>
